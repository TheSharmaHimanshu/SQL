...
SELECT * FROM SCORE
INNER JOIN SUBJECTS
ON SCORE.SUB_ID=SUBJECTS.SUB_ID;

SELECT * FROM ((SCORE
INNER JOIN SUBJECTS ON SCORE.SUB_ID=SUBJECTS.SUB_ID)
INNER JOIN DEPARTMENT ON SUBJECTS.DEPARTMENT_ID=DEPARTMENT.DEPARTMENT_ID);

SELECT FIRST_NAME, LAST_NAME, STUD_SCORE, SUB_NAME 
FROM ((STUDENT 
INNER JOIN SCORE ON STUDENT.STUDENT_ID=SCORE.STUDENT_ID)
INNER JOIN SUBJECTS ON SCORE.SUB_ID=SUBJECTS.SUB_ID);

SELECT FIRST_NAME, LAST_NAME, STUD_SCORE 
FROM STUDENT 
INNER JOIN SCORE ON STUDENT.STUDENT_ID=SCORE.STUDENT_ID;